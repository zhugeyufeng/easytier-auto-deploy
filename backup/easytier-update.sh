...
RELEASE_BASE_URL="https://ghfast.yydy.link:2023/github.com/EasyTier/EasyTier/releases"
VERSION=""
RELEASE_CHANNEL=""
PLATFORM=""
DOWNLOAD_URL=""
...
使用方法:
  easytier-update.sh --stable [platform]     # 下载最新稳定版
  easytier-update.sh --prerelease [platform] # 下载最新 Pre-release 版
  easytier-update.sh [platform]              # 交互选择稳定版或 Pre-release
...
示例:
  easytier-update.sh --stable
  easytier-update.sh --prerelease
  easytier-update.sh --stable x86_64
  easytier-update.sh aarch64
